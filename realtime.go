...
func (s *realtime) RealtimeGetRTChannel(ctx context.Context, request operations.RealtimeGetRTChannelRequest) (*operations.RealtimeGetRTChannelResponse, error) {
	baseURL := s.serverURL
...
func (s *realtime) RealtimeGetRTChannels(ctx context.Context, request operations.RealtimeGetRTChannelsRequest) (*operations.RealtimeGetRTChannelsResponse, error) {
	baseURL := s.serverURL
...
func (s *realtime) RealtimeListSubscriptions(ctx context.Context, request operations.RealtimeListSubscriptionsRequest) (*operations.RealtimeListSubscriptionsResponse, error) {
	baseURL := s.serverURL
...
func (s *realtime) RealtimeMessages(ctx context.Context, request operations.RealtimeMessagesRequest) (*operations.RealtimeMessagesResponse, error) {
	baseURL := s.serverURL
...
func (s *realtime) RealtimePresence(ctx context.Context, request operations.RealtimePresenceRequest) (*operations.RealtimePresenceResponse, error) {
	baseURL := s.serverURL
...
func (s *realtime) RealtimeReadMessages(ctx context.Context, request operations.RealtimeReadMessagesRequest) (*operations.RealtimeReadMessagesResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/v1/projects/{project}/realtime/channels/{channel}/messages", request.PathParams)
